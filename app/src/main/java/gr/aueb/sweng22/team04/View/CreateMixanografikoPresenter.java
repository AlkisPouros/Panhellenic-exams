...
public class CreateMixanografikoPresenter {
    ...
    public CreateMixanografikoPresenter(CreateMixanografikoView view,CandidateDAO candidateDAO,MixanografikoDAO mixanografikoDAO, DepartmentDAO departmentDAO,RegisteredDepartmentDAO registeredDepartmentDAO)
    {
        this.view = view;
