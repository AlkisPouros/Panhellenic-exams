...
#### Διεπαφές υλικού
* Ο χρήστης θα πρέπει να διαθέτει κινητό τηλέφωνο Android.

#### Διεπαφές επικοινωνίας
* Το σύστημα θα στέλνει ενημερωτικά ηλεκτρονικά μηνύματα στους υποψηφίους σχετικά με την υποβολή μηχανογραφικού και τα αποτελέσματα των εξετάσεων.

#### Διεπαφές λογισμικού
* Για την αποστολή των ηλεκτρονικών μηνυμάτων, το σύστημα θα επικοινωνεί με τον διακομιστή ηλεκτρονικού ταχυδρομείου του Υπουργείου Παιδείας.
...
#### Διαθεσιμότητα
* Οι λειτουργίες αναζήτησης σχολών, προβολής βάσεων και στατιστικών, και υπολογισμός μορίων, θα πρέπει να είναι διαθέσιμες 24/7.
...
* Οι λειτουργίες αναζήτησης σχολών, προβολής βάσεων και στατιστικών
